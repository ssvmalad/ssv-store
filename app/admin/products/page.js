      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProducts.map(product => {
            return (
            <div key={product.id} onClick={() => openEditModal(product)} className="bg-[#160F0F] rounded-2xl border border-[#2C1E1E] overflow-hidden group cursor-pointer hover:border-[#3D2828] transition flex flex-col shadow-lg hover:shadow-xl hover:shadow-[#D4AF37]/5">
              <div className="aspect-[4/3] bg-[#1C1212] relative overflow-hidden">
                ...
                <div className="absolute top-3 left-3 bg-black/60 backdrop-blur-md border border-white/10 px-2.5 py-1 rounded-md text-[10px] font-mono uppercase tracking-wider text-[#D4AF37]">{product.category}</div>
